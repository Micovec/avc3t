#include "WorkspaceNodeCmpSmaller.h"

namespace AVC3T {
    WorkspaceNodeCmpSmaller::WorkspaceNodeCmpSmaller() :
        WorkspaceNode("Smaller", {WorkspaceNodeInput(WorkspaceIOType_Float), WorkspaceNodeInput(WorkspaceIOType_Float)},
                      {WorkspaceNodeOutput(WorkspaceIOType_Bool, {&m_OutputValue}, -1)}, {IM_COL32(190, 35, 52, 255)}),
        m_OutputValue(false) {}

    WorkspaceNodeCmpSmaller::WorkspaceNodeCmpSmaller(const WorkspaceNodeCmpSmaller& other) :
    ...
    void WorkspaceNodeCmpSmaller::Evaluate(double ts) {
