#include "WorkspaceNodeCmpSmallerEqual.h"

namespace AVC3T {
    WorkspaceNodeCmpSmallerEqual::WorkspaceNodeCmpSmallerEqual() :
        WorkspaceNode("Smaller equal", {WorkspaceNodeInput(WorkspaceIOType_Float), WorkspaceNodeInput(WorkspaceIOType_Float)},
                      {WorkspaceNodeOutput(WorkspaceIOType_Bool, {&m_OutputValue}, -1)}, {IM_COL32(190, 35, 52, 255)}),
        m_OutputValue(false) {}

    WorkspaceNodeCmpSmallerEqual::WorkspaceNodeCmpSmallerEqual(const WorkspaceNodeCmpSmallerEqual& other) :
    ...
    void WorkspaceNodeCmpSmallerEqual::Evaluate(double ts) {
