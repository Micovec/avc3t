#include "WorkspaceNodeVec3Dot.h"

namespace AVC3T {
    WorkspaceNodeVec3Dot::WorkspaceNodeVec3Dot() :
    ...
    WorkspaceNodeVec3Dot::WorkspaceNodeVec3Dot(const WorkspaceNodeVec3Dot& other) :
    ...
    void WorkspaceNodeVec3Dot::Evaluate(double ts) {
        ...
        m_OutputValue = glm::dot(*input0->Link->OutputPin.Output.Value.vec3, *input1->Link->OutputPin.Output.Value.vec3);
    }
}