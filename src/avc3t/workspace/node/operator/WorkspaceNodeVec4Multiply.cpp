#include "WorkspaceNodeVec4Multiply.h"

namespace AVC3T {
    WorkspaceNodeVec4Multiply::WorkspaceNodeVec4Multiply() :
    ...
    WorkspaceNodeVec4Multiply::WorkspaceNodeVec4Multiply(const WorkspaceNodeVec4Multiply& other) :
    ...
    void WorkspaceNodeVec4Multiply::Evaluate(double ts) {
