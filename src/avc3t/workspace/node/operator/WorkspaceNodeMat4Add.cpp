#include "WorkspaceNodeMat4Add.h"

namespace AVC3T {
    WorkspaceNodeMat4Add::WorkspaceNodeMat4Add() :
    ...
    WorkspaceNodeMat4Add::WorkspaceNodeMat4Add(const WorkspaceNodeMat4Add& other) :
    ...
    void WorkspaceNodeMat4Add::Evaluate(double ts) {
