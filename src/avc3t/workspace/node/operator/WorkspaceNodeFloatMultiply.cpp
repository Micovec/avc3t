#include "WorkspaceNodeFloatMultiply.h"

namespace AVC3T {
    WorkspaceNodeFloatMultiply::WorkspaceNodeFloatMultiply() :
    ...
    WorkspaceNodeFloatMultiply::WorkspaceNodeFloatMultiply(const WorkspaceNodeFloatMultiply& other) :
    ...
    void WorkspaceNodeFloatMultiply::Evaluate(double ts) {
