#include "WorkspaceNodeProjOrtho.h"

namespace AVC3T {
    WorkspaceNodeProjOrtho::WorkspaceNodeProjOrtho() :
        WorkspaceNode("Orthographic",
                      {
    ...
    WorkspaceNodeProjOrtho::WorkspaceNodeProjOrtho(const WorkspaceNodeProjOrtho& other) :
    ...
    void WorkspaceNodeProjOrtho::Evaluate(double ts) {
        ...
        m_Matrix = glm::ortho(*input0->Link->OutputPin.Output.Value.f, *input1->Link->OutputPin.Output.Value.f, *input2->Link->OutputPin.Output.Value.f,
