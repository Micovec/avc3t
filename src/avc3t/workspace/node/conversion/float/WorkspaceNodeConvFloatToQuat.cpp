#include "WorkspaceNodeConvFloatToQuat.h"

namespace AVC3T {
    WorkspaceNodeConvFloatToQuat::WorkspaceNodeConvFloatToQuat() :
        WorkspaceNode("4x Float -> Quat",
    ...
    WorkspaceNodeConvFloatToQuat::WorkspaceNodeConvFloatToQuat(const WorkspaceNodeConvFloatToQuat& other) :
    ...
    void WorkspaceNodeConvFloatToQuat::Evaluate(double ts) {
