...
namespace AVC3T {
    void TextSerializer::Serialize(Workspace& workspace, Scene& scene, std::istream& stream) {
        stream >> std::noskipws;
        stream >> m_StreamExpect.Expect(SERDER_TEXT);
    ...
    void TextSerializer::MakeConnections(Workspace& workspace, std::map<std::size_t, std::shared_ptr<WorkspaceNode>>& nodes,
                                         std::map<std::size_t, std::vector<std::tuple<std::size_t, std::size_t, std::size_t>>>& connections) {
    ...
    TextSerializer::SerializeNode(std::map<std::size_t, std::vector<std::tuple<std::size_t, std::size_t, std::size_t>>>& connections, Scene& scene, std::istream& stream) {
    ...
    std::pair<std::shared_ptr<WorkspaceNode>, bool> TextSerializer::SerializeNodeType(Scene& scene, std::istream& stream) {
        std::pair<std::shared_ptr<WorkspaceNode>, bool> nodePair = {nullptr, false};
    ...
    std::size_t TextSerializer::SerializeId(std::istream& stream) {
        std::size_t id;
    ...
    ImVec2 TextSerializer::SerializePosition(std::istream& stream) {
        ImVec2 position(0, 0);
    ...
    std::string TextSerializer::SerializeTitle(std::istream& stream) {
        std::string title;
    ...
    std::vector<std::tuple<std::size_t, std::size_t, std::size_t>> TextSerializer::SerializeOutputConnections(WorkspaceNode& node, bool serializeValues, std::istream& stream) {
    ...
    void TextSerializer::SerializeIOValue(const WorkspaceIOType& type, const WorkspaceIOValue& value, std::istream& stream) {
    ...
    std::shared_ptr<WorkspaceNode> TextSerializer::SerializeNode_WorkspaceNodeEmbeddedObject(Scene& scene, std::istream& stream) {
