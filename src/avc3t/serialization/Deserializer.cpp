...
namespace AVC3T {
    void Deserializer::Deserialize(const Workspace& workspace, std::ostream& stream) {
    ...
    void Deserializer::DeserializeElement(const std::shared_ptr<WorkspaceElement>& element, std::ostream& stream) {
    ...
    void Deserializer::DeserializeNode(const char* name, WorkspaceNode& node, bool deserializeValues, std::ostream& stream) {
        DeserializeNodeName(name, stream);
        DeserializeNodeProperties(node, deserializeValues, stream);
    }

    void Deserializer::DeserializeNodeName(const char* name, std::ostream& stream) {
        stream << m_Tabs << name << SERDER_COLUMN << std::endl;
    }

    void Deserializer::DeserializeNodeProperties(WorkspaceNode& node, bool deserializeValues, std::ostream& stream) {
        m_Tabs++;
    ...
    void Deserializer::DeserializeOutputs(std::vector<std::shared_ptr<WorkspaceOutputPin>>& outputs, bool deserializeValues, std::ostream& stream) {
    ...
    void Deserializer::DeserializeIOValue(const WorkspaceIOType& type, const WorkspaceIOValue& value, std::ostream& stream) {
    ...
    void Deserializer::DeserializeNode_WorkspaceNodeEmbeddedObject(WorkspaceNodeEmbeddedObject& node, std::ostream& stream) {
    ...
    void Deserializer::DeserializeNode_WorkspaceNodeExternalObject(WorkspaceNodeExternalObject& node, std::ostream& stream) {
    ...
    void Deserializer::DeserializeNode_WorkspaceNodeSceneObject(WorkspaceNodeSceneObject& node, std::ostream& stream) {
    ...
    void Deserializer::DeserializeNode_WorkspaceNodeCamera(WorkspaceNodeCamera& node, std::ostream& stream) {
    ...
    void Deserializer::DeserializeNode_WorkspaceNodeText(WorkspaceNodeText& node, std::ostream& stream) {
